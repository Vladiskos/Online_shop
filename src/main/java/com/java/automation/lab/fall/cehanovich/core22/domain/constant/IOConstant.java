...
public class IOConstant {
    ...
    public static final String CONFIG_PATH = System.getProperties().getProperty("user.dir") +
            "src/main/resources/config.properties";
    public static final String MYBATIS_CONFIG_PATH = System.getProperties().getProperty("user.dir") +
